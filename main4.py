            ...
            for vvariable in [True]:
                for vnbeta in [2.]:#2.]:
                    for vdbeta in [0.4]:#,1.2, 2., 2.8,3.6]:
                        ...
                        print('HHHHHHHHHHHHHHHHHHH',torch.FloatTensor(gennorm(beta=0.5).rvs(size=[1,20000])).to(device),torch.FloatTensor(gennorm(beta=1.).rvs(size=[1,20000])).to(device),torch.FloatTensor(gennorm(beta=2.).rvs(size=[1,20000])).to(device),torch.FloatTensor(gennorm(beta=3.).rvs(size=[1,20000])).to(device),torch.FloatTensor(gennorm(beta=5.).rvs(size=[1,20000])).to(device))
