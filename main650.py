    ...
    def __init__(self, dims=(2, ), datatype=None, cfg=None, **dist_args):
        ...
        if self._bdist_type == 'mvn':
            ...
            if self._var_base_dist == True:
                ...
                self.p = torch.nn.Parameter(torch.zeros((self.dimension,), dtype=torch.float32,device = self.device) + dist_args['p'], requires_grad = True)
...
#---------------------------------------000000000000000000
        ...
        #print('!!!',self.base_distribution.log_prob(z).shape,log_det_jacobian.shape)
        #$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
        nkl = -1.0 * torch.mean(model.base_distribution.log_prob(z) + log_det_jacobian)
